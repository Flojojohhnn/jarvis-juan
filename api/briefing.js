...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Traer eventos del rango y sincronizar leads existentes
    ...
    // Filtrar eventos de hoy (en AR = UTC-3)
    ...
    // Detectar tipo de briefing según hora AR
    ...
    console.error('[ERROR] briefing:', err.message, err.stack);
    try {
